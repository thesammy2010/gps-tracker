...
from gps_tracker.discord import generate_content, format_url, func_map, post_to_discord
...
class TestGenerateContent:
    ...
    def test_generate_func_maps(self, key: str, input_value: str | float | datetime.datetime, expected_result: str) -> None:
